...
public class RegistroIncorrectoEmailExiste {
  ...
  @Test
  public void testRegistroIncorrectoEmailExiste() throws Exception {
    ...
    driver.findElement(By.name("email")).sendKeys("jjcanada@ual.es");
    driver.findElement(By.xpath("//input[@id='usuario']")).click();
    driver.findElement(By.xpath("//input[@id='usuario']")).clear();
    driver.findElement(By.xpath("//input[@id='usuario']")).sendKeys("jj");
