...
public class SalirSistema {
  ...
  @Test
  public void testSalirSistema() throws Exception {
    ...
    driver.findElement(By.linkText("Salir del sistema")).click();
    driver.findElement(By.linkText("Volver a pagina de inicio")).click();
  }
