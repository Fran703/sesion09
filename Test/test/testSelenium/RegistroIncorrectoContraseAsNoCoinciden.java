...
public class RegistroIncorrectoContraseAsNoCoinciden {
  ...
  @Test
  public void testRegistroIncorrectoContraseAsNoCoinciden() throws Exception {
    ...
    driver.findElement(By.xpath("//input[@id='usuario']")).sendKeys("prueba");
