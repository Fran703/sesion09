...
public class CrearUsuarioCorrecto {
  ...
  public void testCrearUsuarioCorrecto() throws Exception {
    ...
    driver.findElement(By.name("email")).sendKeys("pepito@gmail.com");
    driver.findElement(By.name("usuario")).click();
    driver.findElement(By.name("usuario")).clear();
    driver.findElement(By.name("usuario")).sendKeys("pepito");
    driver.findElement(By.name("clave")).click();
    driver.findElement(By.name("clave")).clear();
    driver.findElement(By.name("clave")).sendKeys("1234");
    ...
    driver.findElement(By.name("activo")).click();
    driver.findElement(By.xpath("(//input[@name='rol'])[2]")).click();
